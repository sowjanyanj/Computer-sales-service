<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="register.aspx.cs" Inherits="bgroup9.register" %>
...
<body>
    ...
    <form id="form2" runat="server" class="auto-style1">
        ...
        <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToValidate="txtdateob" ErrorMessage="Age must be greater than or equal to 21" ForeColor="Red" Operator="LessThanEqual" Type="Date" ValueToCompare="01/01/2021"></asp:CompareValidator>
        <asp:TextBox ID="txtdateob" runat="server" CssClass="input" TextMode="Date"></asp:TextBox>
...
&nbsp;<asp:TextBox ID="txtpass" runat="server" CssClass="input" TextMode="Password"></asp:TextBox>
        ...
        <div class="button">
            <asp:Button ID="btncreate" runat="server" CssClass="Button1" Text="Create" OnClick="Button1_Click" BackColor="#33CC33" Width="345px" />
